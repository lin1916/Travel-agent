...
export const SupplierOrderLifecycleSchema = z.enum(['creating','creation_unknown','awaiting_payment','payment_processing','payment_unknown','paid','confirmed','cancelling','cancellation_unknown','cancelled','refunding','refunded','failed','expired']);
