...
export interface RevalidatedOffer { offerId: string; snapshotHash: string; price: Money; inventoryAvailable: boolean; refundRulesHash: string; startsAt?: string; endsAt?: string }
...
export const RevalidatedOfferSchema = z.object({ offerId: z.string(), snapshotHash: z.string(), price: MoneySchema, inventoryAvailable: z.boolean(), refundRulesHash: z.string(), startsAt: timezonedIso.optional(), endsAt: timezonedIso.optional() });
